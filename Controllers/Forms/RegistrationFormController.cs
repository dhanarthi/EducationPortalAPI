...
namespace EducationPortalAPI.Controllers.Forms
{
    ...
    public class RegistrationFormController : ControllerBase
    {
        ...
        public Tuple<bool, int, string> Post(RegistrationFormEntity registrationForm = null)
        {
            ...
            try
            {
                ...
                sqlParameters.Add(new KeyValuePair<string, string>("@UserId", registrationForm.UserId));
                ...
                sqlParameters.Add(new KeyValuePair<string, string>("@MotherTongue", Convert.ToString(registrationForm.MotherTongue)));
                ...
                sqlParameters.Add(new KeyValuePair<string, string>("@FYearlyIncome", registrationForm.FYearlyIncome));
                ...
                sqlParameters.Add(new KeyValuePair<string, string>("@MYearlyIncome", registrationForm.MYearlyIncome));
        ...
        [HttpGet("{id}")]
        public string Get(string Type,string Value, string SchoolId, string RoleId)
        {
            ManageSQLConnection manageSQLConnection = new ManageSQLConnection();
            ...
            if(Type == "1")
            {
                ...
                sqlParameters.Add(new KeyValuePair<string, string>("@UserId", Value));
                sqlParameters.Add(new KeyValuePair<string, string>("@RoleId", RoleId));
                procedure = "GetRegistrationByCreatedUser";
            }
            else
            {
            ...
            var data = manageSQLConnection.GetDataSetValues(procedure, sqlParameters);
    ...
    public class RegistrationFormEntity
    {
        ...
        public string FYearlyIncome { get; set; }
        ...
        public string MYearlyIncome { get; set; }
